...
const GraphicDesigning = () => {
  return (
    <div className="graphic-designing-container">
        <Navbar/>
    <div className="graphic-designing-div">
      <div className="graphic-designing-text">
        <h1>Graphic Designing</h1>
        <p>
          Thank you for visiting our Graphic Designing! We are currently working on
          updating my projects and content to better showcase my skills and experience.
        </p>
        <p className="graphic-designing-highlight">STAY TUNED FOR EXCITING UPDATES !</p>
      </div>
